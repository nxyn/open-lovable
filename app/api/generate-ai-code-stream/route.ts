...
`;
        ...
        console.log(`[generate-ai-code-stream] Using provider: ${isOpenRouter ? 'OpenRouter' : isAnthropic ? 'Anthropic' : isGoogle ? 'Google' : isOpenAI ? 'OpenAI' : 'Groq'}, model: ${actualModel}`);
